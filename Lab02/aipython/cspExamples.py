...
from aipython.cspProblem import Variable, CSP, Constraint        
from aipython.operator import lt,ne,eq,gt
...
# pij is the variable representing the letter i from aipython.the left and j down (starting from aipython.0)
