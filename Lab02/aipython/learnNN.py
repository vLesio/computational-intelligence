...
from aipython.learnProblem import Learner, Data_set, Data_from_file, Data_from_files, Evaluate
from aipython.learnLinear import sigmoid, one, softmax, indicator
...
class NN(Learner):
    ...
    def add_layer(self,layer):
        ...
        Each layer gets number of inputs from aipython.the previous layers outputs.
        """
...
from aipython.utilities import flip
...
from aipython.learnLinear import plot_steps
from aipython.learnProblem import Evaluate
