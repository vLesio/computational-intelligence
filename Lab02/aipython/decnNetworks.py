...
from aipython.probFactors import Factor, CPD, TabFactor, factor_times, Prob
...
class UtilityTable(TabFactor, Utility):
    ...
    def __init__(self, vars, table, position=None):
        """Creates a factor on vars from aipython.the table.
...
from aipython.probRC import connected_components
