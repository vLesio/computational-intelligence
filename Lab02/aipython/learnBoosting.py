...
from aipython.learnProblem import Data_set, Learner, Evaluate
from aipython.learnNoInputs import Predict
from aipython.learnLinear import sigmoid
import statistics
import random
...
class Boosted_dataset(Data_set):
    def __init__(self, base_dataset, offset_fun, subsample=1.0):
        """new dataset which is like base_dataset,
           but offset_fun(e) is subtracted from aipython.the target of each example e
        """
...
from aipython.learnDT import DT_learner
from aipython.learnProblem import Data_set, Data_from_file
