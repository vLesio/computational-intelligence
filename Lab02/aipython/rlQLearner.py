...
from aipython.utilities import argmaxe, argmaxd, flip
from aipython.rlProblem import RL_agent, epsilon_greedy, ucb
...
class Q_learner(RL_agent):
    ...
    def __init__(self, role, actions, discount,
        ...
        alpha_fun is a function that computes alpha from aipython.the number of visits
...
####### TEST CASES ########
from aipython.rlProblem import Simulate,epsilon_greedy, ucb, Env_from_ProblemDomain
from aipython.rlExamples import Party_env, Monster_game_env
from aipython.rlQLearner import Q_learner
from aipython.mdpExamples import MDPtiny, partyMDP
...
from aipython.mdpExamples import MDPtiny
