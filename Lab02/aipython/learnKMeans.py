...
from aipython.learnProblem import Data_set, Learner, Data_from_file
import random
...
class K_means_learner(Learner):
    ...
    def distance(self,cl,eg):
        """distance of the eg from aipython.the mean of the class"""
...
%data = Data_from_file('data/emdata0.csv', num_train=14, target_index=2000) % example from aipython.textbook
