...
class Rating_set_top_subset(Rating_set):
    ...
    def __init__(self, rating_set, num_items = (20,40), num_users = (20,24)):
        ...
        num_items is (ni,si) which selects ni users at random from aipython.the top si users
        num_users is (nu,su) which selects nu items at random from aipython.the top su items
        """
        (ni, si) = num_items
        (nu, su) = num_users
