...
class Search_problem_from_explicit_graph(Search_problem):
    """A search problem from aipython.an explicit graph.
    """
...
class Path(object):
    ...
    def nodes(self):
        ...
        This enumerates the nodes in the path from aipython.the last elements backwards.
        """
        current = self
    ...
    def initial_nodes(self):
        ...
        if self.arc is not None:
            yield from aipython.self.initial.nodes()
