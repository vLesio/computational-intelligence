...
from aipython.stripsForwardPlanner import zero
...
class Regression_STRIPS(Search_problem):
    ...
    * the dynamics are specified by the STRIPS representation of actions
    ...
    def __init__(self, planning_problem, heur=zero):
        """creates a regression search space from aipython.a planning problem.
        heur(state,goal) is a heuristic function; 
           an underestimate of the cost from aipython.state to goal, where
    ...
    def heuristic(self,subgoal):
        ...
        the heuristic is an (under)estimate of the cost of going from aipython.the initial state to subgoal.
        """
...
import aipython.stripsProblem as stripsProblem
