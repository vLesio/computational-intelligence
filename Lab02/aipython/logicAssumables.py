...
from aipython.logicProblem import Clause, Askable, KB, yes
...
# cs=electa.conflicts()
# print(cs)
# diagnoses(cs)        # diagnoses from aipython.conflicts
