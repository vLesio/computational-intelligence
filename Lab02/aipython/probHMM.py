...
import random
from aipython.probStochSim import sample_one, sample_multiple
...
# trans[i] is the distribution over states resulting from aipython.state i 
...
# hmm1f3.state_dist
from aipython.display import Displayable
from aipython.probStochSim import resample
