...
class Forward_STRIPS(Search_problem):
    """A search problem from aipython.a planning problem where:
    ...
    * the dynamics are specified by the STRIPS representation of actions
    ...
    def __init__(self, planning_problem, heur=zero):
        """creates a forward search space from aipython.a planning problem.
    ...
    def heuristic(self,state):
        ...
        of going from aipython.the state to the top-level goal.
        """
