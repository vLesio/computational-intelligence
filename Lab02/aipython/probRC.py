...
import math
from aipython.probGraphicalModels import GraphicalModel, InferenceMethod
from aipython.probFactors import Factor
...
def connected_components(context, factors, split_order):
    ...
    such that each element shares the same variables that are disjoint from aipython.other elements.
    """
...
from aipython.probGraphicalModels import bn_4ch, A,B,C,D,f_a,f_b,f_c,f_d
...
from aipython.probExamples import bn_report,Alarm,Fire,Leaving,Report,Smoke,Tamper
...
from aipython.probExamples import bn_sprinkler, Season, Sprinkler, Rained, Grass_wet, Grass_shiny, Shoes_wet
...
from aipython.probExamples import bn_no1, bn_lr1, Cough, Fever, Sneeze, Cold, Flu, Covid
...
from aipython.probFactors import Prob, action, rain, full, wet, p_wet
