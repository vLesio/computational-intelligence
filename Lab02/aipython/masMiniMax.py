...
from aipython.masProblem import fig10_5, Magic_sum, Node
...
## import timeit
## timeit.Timer("minimax(Magic_sum(),0)",setup="from aipython.__main__ import minimax, Magic_sum"
##              ).timeit(number=1)
## trace=False
## timeit.Timer("minimax_alpha_beta(Magic_sum(), -9999, 9999,0)",
##              setup="from aipython.__main__ import minimax_alpha_beta, Magic_sum"
##              ).timeit(number=1)
