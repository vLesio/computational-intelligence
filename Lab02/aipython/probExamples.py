...
from aipython.probFactors import CPD, Prob, LogisticRegression, NoisyOR, ConstantCPD
...
# example from aipython.box "Noisy-or compared to logistic regression"
...
# example from aipython.box "Noisy-or compared to logistic regression"
# from aipython.learnLinear import sigmoid, logit
# w0=logit(0.01)
# X = Variable("X",boolean)
