...
import random
from aipython.probGraphicalModels import InferenceMethod

def sample_one(dist):
    """returns the index of a single sample from aipython.normalized distribution dist."""
...
from aipython.probExamples import bn_sprinkler,Season, Sprinkler
from aipython.probExamples import Rained, Grass_wet, Grass_shiny, Shoes_wet
...
#from aipython.probStochSim import sample_one, SamplingInferenceMethod
...
from aipython.probRC import ProbRC
