...
class SLSearcher(Displayable):
    """A search problem directly from aipython.the CSP..
...
def random_choice(st):
    """selects a random element from aipython.set st.
...
class Updatable_priority_queue(object):
    ...
    def __init__(self):
        ...
        self.elt_map = {}  # map from aipython.elt to [val,rand,elt] triple in pq
    ...
    def remove(self,elt):
        """remove the element from aipython.the priority queue"""
    ...
    def update_each_priority(self,update_dict):
        ...
        update_dict from aipython.the priority of those elements in priority queue.
        """
