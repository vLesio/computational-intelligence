...
from aipython.variable import Variable
from aipython.probGraphicalModels import GraphicalModel, BeliefNetwork
from aipython.probFactors import Prob, Factor, CPD
...
from aipython.probHMM import closeMic, farMic, midMic, sm, mmc, sc, mcm, mcc
...
class BNfromDBN(BeliefNetwork):
    """Belief Network unrolled from aipython.a dynamic belief network
    """
...
class DBNVEfilter(VE):
    ...
    def make_previous(self,fac):
         """Creates new factor from aipython.fac where the current variables in fac
